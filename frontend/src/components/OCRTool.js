...
//       } else {
//         setPreview(null); // Clear preview for PDFs
//       }
...
//     } catch (err) {
//       setError(err.response?.data?.error || '파일 처리 중 오류가 발생했습니다. 다시 시도해주세요.');
...
//   return (
//     <div className="max-w-4xl mx-auto mt-8 pt-8">
...
//                       {result.file && (
//                         <a 
//                           href={`http://localhost:8000${result.file}`} 
//                           target="_blank" 
...
//                     <div className="flex justify-center">
//                       <img 
//                         src={`http://localhost:8000${result.file}`} 
//                         alt="Uploaded" 
...
//               <h3 className="text-lg font-medium text-gray-900 mb-2">LLM 분석</h3>
//               <div className="bg-white p-3 rounded border border-gray-200">
